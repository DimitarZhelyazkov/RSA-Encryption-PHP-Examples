# RSA-Encryption-PHP-Examples
 Scripts with RSA Algorithm
	...
	Формули:
	Нека P и Q са прайм числа.
	N = P * Q
	Fn = (P -1) * (Q -1)
	E - трябва да е между 1 и Fn (1 < E < Fn) и да няма обши делетиле с N и Fn. Също трябва да е прайм.
	D - може да е всяко число отговарящо на формулата (D * E) % Fn == 1